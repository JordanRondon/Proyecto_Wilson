...
namespace CapaPresentacion
{
    public partial class FormMetodoPago : Form
    {
        ...
        private void dgvMetodoPago_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (MessageBox.Show("¿Seguro que deseas eliminar?", "Eliminar Metodo Pago", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes)
        ...
        private void btnAgregarMetodoPago_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if(txtNombreMetodoPago.Text != ""  && cbCategoriaMetodoPago.SelectedIndex != -1)
                {
